...
namespace CareerLens.Contracts.Requests.Interviewes
{
    public class UpdateInterviewRequest
    {
        ...
        public List<UpdateInterviewQuestionRequest> Questions { get; set; } = [];
    }
    public sealed class UpdateInterviewRequestValidator
    : AbstractValidator<UpdateInterviewRequest>
    {
        public UpdateInterviewRequestValidator()
        {
            ...
            RuleForEach(x => x.Questions)
                .SetValidator(new UpdateInterviewQuestionRequestValidator())
